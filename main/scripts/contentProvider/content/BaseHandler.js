...
// PARAMETER: e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleTableEvent=function(e)
{
...
// PARAMETER: e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleListEvent=function(e)
{
    var thisObject = this;
...
// PARAMETER: e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleBlockquoteEvent=function(e)
{
    // Switch statement handles specific keystroke behavior
    switch(e.type)
    {
...
// PARAMETER: e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleParagraphEvent=function(e)
{
    // Switch statement handles specific keystroke behavior
    switch(e.type)
    {
...
// PARAMETER: e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleHeaderEvent=function(e)
{
    if(e.type=="keydown")
    {
        switch(e.keyCode)
        {
            ...
            case 13:					
                ...
                {
                    var newParagraph = $("<p>")
                    rangeParent.replaceWith(newParagraph);
...
// PARAMETER: e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleInputEvent=function(e)
{
...
// PARAMETER: e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleILOEvent=function(e)
{
    if(e.type=='keyup')
    {
...
// PARAMETER:  e is an object of type Event
// RETURNS: void
BaseHandler.prototype.handleGeneralEvent=function(e)
{
    var thisObject = this;
